...
| <code><a href="#cdk-internal-gateway.LocalNSLookupResolverStack.splitArn">splitArn</a></code> | Splits the provided ARN into its components. |
...
###### `key`<sup>Required</sup> <a name="key" id="cdk-internal-gateway.LocalNSLookupResolverStack.addMetadata.parameter.key"></a>
...
##### `formatArn` <a name="formatArn" id="cdk-internal-gateway.LocalNSLookupResolverStack.formatArn"></a>
...
###### `newId`<sup>Required</sup> <a name="newId" id="cdk-internal-gateway.LocalNSLookupResolverStack.renameLogicalId.parameter.newId"></a>
...
###### `arn`<sup>Required</sup> <a name="arn" id="cdk-internal-gateway.LocalNSLookupResolverStack.splitArn.parameter.arn"></a>
...
###### `components`<sup>Required</sup> <a name="components" id="cdk-internal-gateway.ResourceQueryResolverStack.formatArn.parameter.components"></a>
...
###### `factName`<sup>Required</sup> <a name="factName" id="cdk-internal-gateway.ResourceQueryResolverStack.regionalFact.parameter.factName"></a>
...
###### `arn`<sup>Required</sup> <a name="arn" id="cdk-internal-gateway.ResourceQueryResolverStack.splitArn.parameter.arn"></a>
...
###### `arnFormat`<sup>Required</sup> <a name="arnFormat" id="cdk-internal-gateway.ResourceQueryResolverStack.splitArn.parameter.arnFormat"></a>
...
##### `toJsonString` <a name="toJsonString" id="cdk-internal-gateway.ResourceQueryResolverStack.toJsonString"></a>
...
###### `obj`<sup>Required</sup> <a name="obj" id="cdk-internal-gateway.ResourceQueryResolverStack.toJsonString.parameter.obj"></a>

- *Type:* any

---

###### `space`<sup>Optional</sup> <a name="space" id="cdk-internal-gateway.ResourceQueryResolverStack.toJsonString.parameter.space"></a>

- *Type:* number

---

##### `setIpAddressesOutput` <a name="setIpAddressesOutput" id="cdk-internal-gateway.ResourceQueryResolverStack.setIpAddressesOutput"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.isStack">isStack</a></code> | Return whether the given object is a Stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.of">of</a></code> | Looks up the first stack scope in which `construct` is defined. |

---

##### ~~`isConstruct`~~ <a name="isConstruct" id="cdk-internal-gateway.ResourceQueryResolverStack.isConstruct"></a>

```typescript
import { ResourceQueryResolverStack } from 'cdk-internal-gateway'

ResourceQueryResolverStack.isConstruct(x: any)
```

Checks if `x` is a construct.

###### `x`<sup>Required</sup> <a name="x" id="cdk-internal-gateway.ResourceQueryResolverStack.isConstruct.parameter.x"></a>
...
##### `isStack` <a name="isStack" id="cdk-internal-gateway.ResourceQueryResolverStack.isStack"></a>

```typescript
import { ResourceQueryResolverStack } from 'cdk-internal-gateway'

ResourceQueryResolverStack.isStack(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="cdk-internal-gateway.ResourceQueryResolverStack.isStack.parameter.x"></a>

- *Type:* any

---

##### `of` <a name="of" id="cdk-internal-gateway.ResourceQueryResolverStack.of"></a>

```typescript
import { ResourceQueryResolverStack } from 'cdk-internal-gateway'

ResourceQueryResolverStack.of(construct: IConstruct)
```
...
###### `construct`<sup>Required</sup> <a name="construct" id="cdk-internal-gateway.ResourceQueryResolverStack.of.parameter.construct"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.account">account</a></code> | <code>string</code> | The AWS account into which this stack will be deployed. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.artifactId">artifactId</a></code> | <code>string</code> | The ID of the cloud assembly artifact for this stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.availabilityZones">availabilityZones</a></code> | <code>string[]</code> | Returns the list of AZs that are available in the AWS environment (account/region) associated with this stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.bundlingRequired">bundlingRequired</a></code> | <code>boolean</code> | Indicates whether the stack requires bundling or not. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.dependencies">dependencies</a></code> | <code>aws-cdk-lib.Stack[]</code> | Return the stacks this stack depends on. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.environment">environment</a></code> | <code>string</code> | The environment coordinates in which this stack is deployed. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.nested">nested</a></code> | <code>boolean</code> | Indicates if this is a nested stack, in which case `parentStack` will include a reference to it's parent. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.notificationArns">notificationArns</a></code> | <code>string[]</code> | Returns the list of notification Amazon Resource Names (ARNs) for the current stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.partition">partition</a></code> | <code>string</code> | The partition in which this stack is defined. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.region">region</a></code> | <code>string</code> | The AWS region into which this stack will be deployed (e.g. `us-west-2`). |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.stackId">stackId</a></code> | <code>string</code> | The ID of the stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.stackName">stackName</a></code> | <code>string</code> | The concrete CloudFormation physical stack name. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.synthesizer">synthesizer</a></code> | <code>aws-cdk-lib.IStackSynthesizer</code> | Synthesis method for this stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.tags">tags</a></code> | <code>aws-cdk-lib.TagManager</code> | Tags to be applied to the stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.templateFile">templateFile</a></code> | <code>string</code> | The name of the CloudFormation template file emitted to the output directory during synthesis. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.templateOptions">templateOptions</a></code> | <code>aws-cdk-lib.ITemplateOptions</code> | Options for CloudFormation template (like version, transform, description). |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.urlSuffix">urlSuffix</a></code> | <code>string</code> | The Amazon domain suffix for the region in which this stack is defined. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.nestedStackParent">nestedStackParent</a></code> | <code>aws-cdk-lib.Stack</code> | If this is a nested stack, returns it's parent stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.nestedStackResource">nestedStackResource</a></code> | <code>aws-cdk-lib.CfnResource</code> | If this is a nested stack, this represents its `AWS::CloudFormation::Stack` resource. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.terminationProtection">terminationProtection</a></code> | <code>boolean</code> | Whether termination protection is enabled for this stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverStack.property.vcpEndpointIpAddresses">vcpEndpointIpAddresses</a></code> | <code>string[]</code> | Ip Addresses of the vpc endpoint used to forward requests from the load balancer`s target group to the internal api gateway. |

---

##### `node`<sup>Required</sup> <a name="node" id="cdk-internal-gateway.ResourceQueryResolverStack.property.node"></a>
...
##### `account`<sup>Required</sup> <a name="account" id="cdk-internal-gateway.ResourceQueryResolverStack.property.account"></a>
...
##### `artifactId`<sup>Required</sup> <a name="artifactId" id="cdk-internal-gateway.ResourceQueryResolverStack.property.artifactId"></a>
...
##### `availabilityZones`<sup>Required</sup> <a name="availabilityZones" id="cdk-internal-gateway.ResourceQueryResolverStack.property.availabilityZones"></a>
...
##### `bundlingRequired`<sup>Required</sup> <a name="bundlingRequired" id="cdk-internal-gateway.ResourceQueryResolverStack.property.bundlingRequired"></a>
...
##### `dependencies`<sup>Required</sup> <a name="dependencies" id="cdk-internal-gateway.ResourceQueryResolverStack.property.dependencies"></a>
...
##### `environment`<sup>Required</sup> <a name="environment" id="cdk-internal-gateway.ResourceQueryResolverStack.property.environment"></a>
...
##### `nested`<sup>Required</sup> <a name="nested" id="cdk-internal-gateway.ResourceQueryResolverStack.property.nested"></a>
...
##### `notificationArns`<sup>Required</sup> <a name="notificationArns" id="cdk-internal-gateway.ResourceQueryResolverStack.property.notificationArns"></a>
...
##### `partition`<sup>Required</sup> <a name="partition" id="cdk-internal-gateway.ResourceQueryResolverStack.property.partition"></a>
...
##### `region`<sup>Required</sup> <a name="region" id="cdk-internal-gateway.ResourceQueryResolverStack.property.region"></a>
...
##### `stackId`<sup>Required</sup> <a name="stackId" id="cdk-internal-gateway.ResourceQueryResolverStack.property.stackId"></a>
...
##### `stackName`<sup>Required</sup> <a name="stackName" id="cdk-internal-gateway.ResourceQueryResolverStack.property.stackName"></a>
...
##### `synthesizer`<sup>Required</sup> <a name="synthesizer" id="cdk-internal-gateway.ResourceQueryResolverStack.property.synthesizer"></a>
...
##### `tags`<sup>Required</sup> <a name="tags" id="cdk-internal-gateway.ResourceQueryResolverStack.property.tags"></a>
...
##### `templateFile`<sup>Required</sup> <a name="templateFile" id="cdk-internal-gateway.ResourceQueryResolverStack.property.templateFile"></a>
...
##### `templateOptions`<sup>Required</sup> <a name="templateOptions" id="cdk-internal-gateway.ResourceQueryResolverStack.property.templateOptions"></a>
...
##### `urlSuffix`<sup>Required</sup> <a name="urlSuffix" id="cdk-internal-gateway.ResourceQueryResolverStack.property.urlSuffix"></a>
...
##### `nestedStackParent`<sup>Optional</sup> <a name="nestedStackParent" id="cdk-internal-gateway.ResourceQueryResolverStack.property.nestedStackParent"></a>
...
##### `nestedStackResource`<sup>Optional</sup> <a name="nestedStackResource" id="cdk-internal-gateway.ResourceQueryResolverStack.property.nestedStackResource"></a>
...
##### `terminationProtection`<sup>Optional</sup> <a name="terminationProtection" id="cdk-internal-gateway.ResourceQueryResolverStack.property.terminationProtection"></a>
...
##### `vcpEndpointIpAddresses`<sup>Optional</sup> <a name="vcpEndpointIpAddresses" id="cdk-internal-gateway.ResourceQueryResolverStack.property.vcpEndpointIpAddresses"></a>
...
### VpcEndpointIPResolver <a name="VpcEndpointIPResolver" id="cdk-internal-gateway.VpcEndpointIPResolver"></a>

#### Initializers <a name="Initializers" id="cdk-internal-gateway.VpcEndpointIPResolver.Initializer"></a>

```typescript
import { VpcEndpointIPResolver } from 'cdk-internal-gateway'

new VpcEndpointIPResolver(scope?: Construct, id?: string, props?: StackProps)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | Parent of this stack, usually an `App` or a `Stage`, but could be any construct. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.Initializer.parameter.id">id</a></code> | <code>string</code> | The construct ID of this stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.Initializer.parameter.props">props</a></code> | <code>aws-cdk-lib.StackProps</code> | Stack properties. |

---

##### `scope`<sup>Optional</sup> <a name="scope" id="cdk-internal-gateway.VpcEndpointIPResolver.Initializer.parameter.scope"></a>
...
##### `id`<sup>Optional</sup> <a name="id" id="cdk-internal-gateway.VpcEndpointIPResolver.Initializer.parameter.id"></a>
...
##### `props`<sup>Optional</sup> <a name="props" id="cdk-internal-gateway.VpcEndpointIPResolver.Initializer.parameter.props"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.toString">toString</a></code> | Returns a string representation of this construct. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.addDependency">addDependency</a></code> | Add a dependency between this stack and another stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.addMetadata">addMetadata</a></code> | Adds an arbitary key-value pair, with information you want to record about the stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.addTransform">addTransform</a></code> | Add a Transform to this stack. A Transform is a macro that AWS CloudFormation uses to process your template. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.exportValue">exportValue</a></code> | Create a CloudFormation Export for a value. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.formatArn">formatArn</a></code> | Creates an ARN from components. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.getLogicalId">getLogicalId</a></code> | Allocates a stack-unique CloudFormation-compatible logical identity for a specific resource. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.regionalFact">regionalFact</a></code> | Look up a fact value for the given fact for the region of this stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.renameLogicalId">renameLogicalId</a></code> | Rename a generated logical identities. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.reportMissingContextKey">reportMissingContextKey</a></code> | Indicate that a context key was expected. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.resolve">resolve</a></code> | Resolve a tokenized value in the context of the current stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.splitArn">splitArn</a></code> | Splits the provided ARN into its components. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.toJsonString">toJsonString</a></code> | Convert an object, potentially containing tokens, to a JSON string. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.setIpAddressesOutput">setIpAddressesOutput</a></code> | *No description.* |

---

##### `toString` <a name="toString" id="cdk-internal-gateway.VpcEndpointIPResolver.toString"></a>
...
##### `addDependency` <a name="addDependency" id="cdk-internal-gateway.VpcEndpointIPResolver.addDependency"></a>
...
###### `target`<sup>Required</sup> <a name="target" id="cdk-internal-gateway.VpcEndpointIPResolver.addDependency.parameter.target"></a>

- *Type:* aws-cdk-lib.Stack

---

###### `reason`<sup>Optional</sup> <a name="reason" id="cdk-internal-gateway.VpcEndpointIPResolver.addDependency.parameter.reason"></a>

- *Type:* string

---

##### `addMetadata` <a name="addMetadata" id="cdk-internal-gateway.VpcEndpointIPResolver.addMetadata"></a>
...
###### `key`<sup>Required</sup> <a name="key" id="cdk-internal-gateway.VpcEndpointIPResolver.addMetadata.parameter.key"></a>

- *Type:* string

---

###### `value`<sup>Required</sup> <a name="value" id="cdk-internal-gateway.VpcEndpointIPResolver.addMetadata.parameter.value"></a>

- *Type:* any

---

##### `addTransform` <a name="addTransform" id="cdk-internal-gateway.VpcEndpointIPResolver.addTransform"></a>
...
###### `transform`<sup>Required</sup> <a name="transform" id="cdk-internal-gateway.VpcEndpointIPResolver.addTransform.parameter.transform"></a>
...
##### `exportValue` <a name="exportValue" id="cdk-internal-gateway.VpcEndpointIPResolver.exportValue"></a>
...
###### `exportedValue`<sup>Required</sup> <a name="exportedValue" id="cdk-internal-gateway.VpcEndpointIPResolver.exportValue.parameter.exportedValue"></a>

- *Type:* any

---

###### `options`<sup>Optional</sup> <a name="options" id="cdk-internal-gateway.VpcEndpointIPResolver.exportValue.parameter.options"></a>

- *Type:* aws-cdk-lib.ExportValueOptions

---

##### `formatArn` <a name="formatArn" id="cdk-internal-gateway.VpcEndpointIPResolver.formatArn"></a>
...
###### `components`<sup>Required</sup> <a name="components" id="cdk-internal-gateway.VpcEndpointIPResolver.formatArn.parameter.components"></a>

- *Type:* aws-cdk-lib.ArnComponents

---

##### `getLogicalId` <a name="getLogicalId" id="cdk-internal-gateway.VpcEndpointIPResolver.getLogicalId"></a>
...
###### `element`<sup>Required</sup> <a name="element" id="cdk-internal-gateway.VpcEndpointIPResolver.getLogicalId.parameter.element"></a>
...
##### `regionalFact` <a name="regionalFact" id="cdk-internal-gateway.VpcEndpointIPResolver.regionalFact"></a>
...
###### `factName`<sup>Required</sup> <a name="factName" id="cdk-internal-gateway.VpcEndpointIPResolver.regionalFact.parameter.factName"></a>

- *Type:* string

---

###### `defaultValue`<sup>Optional</sup> <a name="defaultValue" id="cdk-internal-gateway.VpcEndpointIPResolver.regionalFact.parameter.defaultValue"></a>

- *Type:* string

---

##### `renameLogicalId` <a name="renameLogicalId" id="cdk-internal-gateway.VpcEndpointIPResolver.renameLogicalId"></a>
...
###### `oldId`<sup>Required</sup> <a name="oldId" id="cdk-internal-gateway.VpcEndpointIPResolver.renameLogicalId.parameter.oldId"></a>

- *Type:* string

---

###### `newId`<sup>Required</sup> <a name="newId" id="cdk-internal-gateway.VpcEndpointIPResolver.renameLogicalId.parameter.newId"></a>

- *Type:* string

---

##### `reportMissingContextKey` <a name="reportMissingContextKey" id="cdk-internal-gateway.VpcEndpointIPResolver.reportMissingContextKey"></a>
...
###### `report`<sup>Required</sup> <a name="report" id="cdk-internal-gateway.VpcEndpointIPResolver.reportMissingContextKey.parameter.report"></a>
...
##### `resolve` <a name="resolve" id="cdk-internal-gateway.VpcEndpointIPResolver.resolve"></a>
...
###### `obj`<sup>Required</sup> <a name="obj" id="cdk-internal-gateway.VpcEndpointIPResolver.resolve.parameter.obj"></a>

- *Type:* any

---

##### `splitArn` <a name="splitArn" id="cdk-internal-gateway.VpcEndpointIPResolver.splitArn"></a>
...
###### `arn`<sup>Required</sup> <a name="arn" id="cdk-internal-gateway.VpcEndpointIPResolver.splitArn.parameter.arn"></a>
...
###### `arnFormat`<sup>Required</sup> <a name="arnFormat" id="cdk-internal-gateway.VpcEndpointIPResolver.splitArn.parameter.arnFormat"></a>
...
##### `toJsonString` <a name="toJsonString" id="cdk-internal-gateway.VpcEndpointIPResolver.toJsonString"></a>
...
###### `obj`<sup>Required</sup> <a name="obj" id="cdk-internal-gateway.VpcEndpointIPResolver.toJsonString.parameter.obj"></a>

- *Type:* any

---

###### `space`<sup>Optional</sup> <a name="space" id="cdk-internal-gateway.VpcEndpointIPResolver.toJsonString.parameter.space"></a>

- *Type:* number

---

##### `setIpAddressesOutput` <a name="setIpAddressesOutput" id="cdk-internal-gateway.VpcEndpointIPResolver.setIpAddressesOutput"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.isStack">isStack</a></code> | Return whether the given object is a Stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.of">of</a></code> | Looks up the first stack scope in which `construct` is defined. |

---

##### ~~`isConstruct`~~ <a name="isConstruct" id="cdk-internal-gateway.VpcEndpointIPResolver.isConstruct"></a>

```typescript
import { VpcEndpointIPResolver } from 'cdk-internal-gateway'

VpcEndpointIPResolver.isConstruct(x: any)
```

Checks if `x` is a construct.

###### `x`<sup>Required</sup> <a name="x" id="cdk-internal-gateway.VpcEndpointIPResolver.isConstruct.parameter.x"></a>
...
##### `isStack` <a name="isStack" id="cdk-internal-gateway.VpcEndpointIPResolver.isStack"></a>

```typescript
import { VpcEndpointIPResolver } from 'cdk-internal-gateway'

VpcEndpointIPResolver.isStack(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="cdk-internal-gateway.VpcEndpointIPResolver.isStack.parameter.x"></a>

- *Type:* any

---

##### `of` <a name="of" id="cdk-internal-gateway.VpcEndpointIPResolver.of"></a>

```typescript
import { VpcEndpointIPResolver } from 'cdk-internal-gateway'

VpcEndpointIPResolver.of(construct: IConstruct)
```
...
###### `construct`<sup>Required</sup> <a name="construct" id="cdk-internal-gateway.VpcEndpointIPResolver.of.parameter.construct"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.account">account</a></code> | <code>string</code> | The AWS account into which this stack will be deployed. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.artifactId">artifactId</a></code> | <code>string</code> | The ID of the cloud assembly artifact for this stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.availabilityZones">availabilityZones</a></code> | <code>string[]</code> | Returns the list of AZs that are available in the AWS environment (account/region) associated with this stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.bundlingRequired">bundlingRequired</a></code> | <code>boolean</code> | Indicates whether the stack requires bundling or not. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.dependencies">dependencies</a></code> | <code>aws-cdk-lib.Stack[]</code> | Return the stacks this stack depends on. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.environment">environment</a></code> | <code>string</code> | The environment coordinates in which this stack is deployed. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.nested">nested</a></code> | <code>boolean</code> | Indicates if this is a nested stack, in which case `parentStack` will include a reference to it's parent. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.notificationArns">notificationArns</a></code> | <code>string[]</code> | Returns the list of notification Amazon Resource Names (ARNs) for the current stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.partition">partition</a></code> | <code>string</code> | The partition in which this stack is defined. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.region">region</a></code> | <code>string</code> | The AWS region into which this stack will be deployed (e.g. `us-west-2`). |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.stackId">stackId</a></code> | <code>string</code> | The ID of the stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.stackName">stackName</a></code> | <code>string</code> | The concrete CloudFormation physical stack name. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.synthesizer">synthesizer</a></code> | <code>aws-cdk-lib.IStackSynthesizer</code> | Synthesis method for this stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.tags">tags</a></code> | <code>aws-cdk-lib.TagManager</code> | Tags to be applied to the stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.templateFile">templateFile</a></code> | <code>string</code> | The name of the CloudFormation template file emitted to the output directory during synthesis. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.templateOptions">templateOptions</a></code> | <code>aws-cdk-lib.ITemplateOptions</code> | Options for CloudFormation template (like version, transform, description). |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.urlSuffix">urlSuffix</a></code> | <code>string</code> | The Amazon domain suffix for the region in which this stack is defined. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.nestedStackParent">nestedStackParent</a></code> | <code>aws-cdk-lib.Stack</code> | If this is a nested stack, returns it's parent stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.nestedStackResource">nestedStackResource</a></code> | <code>aws-cdk-lib.CfnResource</code> | If this is a nested stack, this represents its `AWS::CloudFormation::Stack` resource. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.terminationProtection">terminationProtection</a></code> | <code>boolean</code> | Whether termination protection is enabled for this stack. |
| <code><a href="#cdk-internal-gateway.VpcEndpointIPResolver.property.vcpEndpointIpAddresses">vcpEndpointIpAddresses</a></code> | <code>string[]</code> | Ip Addresses of the vpc endpoint used to forward requests from the load balancer`s target group to the internal api gateway. |

---

##### `node`<sup>Required</sup> <a name="node" id="cdk-internal-gateway.VpcEndpointIPResolver.property.node"></a>
...
##### `account`<sup>Required</sup> <a name="account" id="cdk-internal-gateway.VpcEndpointIPResolver.property.account"></a>
...
##### `artifactId`<sup>Required</sup> <a name="artifactId" id="cdk-internal-gateway.VpcEndpointIPResolver.property.artifactId"></a>
...
##### `availabilityZones`<sup>Required</sup> <a name="availabilityZones" id="cdk-internal-gateway.VpcEndpointIPResolver.property.availabilityZones"></a>
...
##### `bundlingRequired`<sup>Required</sup> <a name="bundlingRequired" id="cdk-internal-gateway.VpcEndpointIPResolver.property.bundlingRequired"></a>
...
##### `dependencies`<sup>Required</sup> <a name="dependencies" id="cdk-internal-gateway.VpcEndpointIPResolver.property.dependencies"></a>
...
##### `environment`<sup>Required</sup> <a name="environment" id="cdk-internal-gateway.VpcEndpointIPResolver.property.environment"></a>
...
##### `nested`<sup>Required</sup> <a name="nested" id="cdk-internal-gateway.VpcEndpointIPResolver.property.nested"></a>
...
##### `notificationArns`<sup>Required</sup> <a name="notificationArns" id="cdk-internal-gateway.VpcEndpointIPResolver.property.notificationArns"></a>
...
##### `partition`<sup>Required</sup> <a name="partition" id="cdk-internal-gateway.VpcEndpointIPResolver.property.partition"></a>
...
##### `region`<sup>Required</sup> <a name="region" id="cdk-internal-gateway.VpcEndpointIPResolver.property.region"></a>
...
##### `stackId`<sup>Required</sup> <a name="stackId" id="cdk-internal-gateway.VpcEndpointIPResolver.property.stackId"></a>
...
##### `stackName`<sup>Required</sup> <a name="stackName" id="cdk-internal-gateway.VpcEndpointIPResolver.property.stackName"></a>
...
##### `synthesizer`<sup>Required</sup> <a name="synthesizer" id="cdk-internal-gateway.VpcEndpointIPResolver.property.synthesizer"></a>
...
##### `tags`<sup>Required</sup> <a name="tags" id="cdk-internal-gateway.VpcEndpointIPResolver.property.tags"></a>
...
##### `templateFile`<sup>Required</sup> <a name="templateFile" id="cdk-internal-gateway.VpcEndpointIPResolver.property.templateFile"></a>
...
##### `templateOptions`<sup>Required</sup> <a name="templateOptions" id="cdk-internal-gateway.VpcEndpointIPResolver.property.templateOptions"></a>
...
##### `urlSuffix`<sup>Required</sup> <a name="urlSuffix" id="cdk-internal-gateway.VpcEndpointIPResolver.property.urlSuffix"></a>
...
##### `nestedStackParent`<sup>Optional</sup> <a name="nestedStackParent" id="cdk-internal-gateway.VpcEndpointIPResolver.property.nestedStackParent"></a>
...
##### `nestedStackResource`<sup>Optional</sup> <a name="nestedStackResource" id="cdk-internal-gateway.VpcEndpointIPResolver.property.nestedStackResource"></a>
...
##### `terminationProtection`<sup>Optional</sup> <a name="terminationProtection" id="cdk-internal-gateway.VpcEndpointIPResolver.property.terminationProtection"></a>
...
##### `vcpEndpointIpAddresses`<sup>Optional</sup> <a name="vcpEndpointIpAddresses" id="cdk-internal-gateway.VpcEndpointIPResolver.property.vcpEndpointIpAddresses"></a>
...
### NSLookupResolverProps <a name="NSLookupResolverProps" id="cdk-internal-gateway.NSLookupResolverProps"></a>

Properties for NSLookupResolverStack.

#### Initializer <a name="Initializer" id="cdk-internal-gateway.NSLookupResolverProps.Initializer"></a>

```typescript
import { NSLookupResolverProps } from 'cdk-internal-gateway'

const nSLookupResolverProps: NSLookupResolverProps = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.analyticsReporting">analyticsReporting</a></code> | <code>boolean</code> | Include runtime versioning information in this Stack. |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.description">description</a></code> | <code>string</code> | A description of the stack. |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.env">env</a></code> | <code>aws-cdk-lib.Environment</code> | The AWS environment (account/region) where this stack will be deployed. |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.stackName">stackName</a></code> | <code>string</code> | Name to deploy the stack with. |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.synthesizer">synthesizer</a></code> | <code>aws-cdk-lib.IStackSynthesizer</code> | Synthesis method to use while deploying this stack. |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Stack tags that will be applied to all the taggable resources and the stack itself. |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.terminationProtection">terminationProtection</a></code> | <code>boolean</code> | Whether to enable termination protection for this stack. |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.serviceName">serviceName</a></code> | <code>string</code> | Service name  used for all cloudformation resource names and internal aws resource names. |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.stage">stage</a></code> | <code>string</code> | Stage name  used for all cloudformation resource names and internal aws resource names. |
| <code><a href="#cdk-internal-gateway.NSLookupResolverProps.property.vpcEndpointDnsName">vpcEndpointDnsName</a></code> | <code>string</code> | DNS Name of execute-api vpc endpoint used for nslookup query. |

---

##### `analyticsReporting`<sup>Optional</sup> <a name="analyticsReporting" id="cdk-internal-gateway.NSLookupResolverProps.property.analyticsReporting"></a>
...
##### `description`<sup>Optional</sup> <a name="description" id="cdk-internal-gateway.NSLookupResolverProps.property.description"></a>
...
##### `env`<sup>Optional</sup> <a name="env" id="cdk-internal-gateway.NSLookupResolverProps.property.env"></a>
...
##### `stackName`<sup>Optional</sup> <a name="stackName" id="cdk-internal-gateway.NSLookupResolverProps.property.stackName"></a>
...
##### `synthesizer`<sup>Optional</sup> <a name="synthesizer" id="cdk-internal-gateway.NSLookupResolverProps.property.synthesizer"></a>
...
##### `tags`<sup>Optional</sup> <a name="tags" id="cdk-internal-gateway.NSLookupResolverProps.property.tags"></a>
...
##### `terminationProtection`<sup>Optional</sup> <a name="terminationProtection" id="cdk-internal-gateway.NSLookupResolverProps.property.terminationProtection"></a>
...
##### `serviceName`<sup>Required</sup> <a name="serviceName" id="cdk-internal-gateway.NSLookupResolverProps.property.serviceName"></a>
...
##### `stage`<sup>Required</sup> <a name="stage" id="cdk-internal-gateway.NSLookupResolverProps.property.stage"></a>
...
##### `vpcEndpointDnsName`<sup>Required</sup> <a name="vpcEndpointDnsName" id="cdk-internal-gateway.NSLookupResolverProps.property.vpcEndpointDnsName"></a>
...
### ResourceQueryResolverProps <a name="ResourceQueryResolverProps" id="cdk-internal-gateway.ResourceQueryResolverProps"></a>

Properties for ResourceQueryResolverStack.

#### Initializer <a name="Initializer" id="cdk-internal-gateway.ResourceQueryResolverProps.Initializer"></a>

```typescript
import { ResourceQueryResolverProps } from 'cdk-internal-gateway'

const resourceQueryResolverProps: ResourceQueryResolverProps = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.analyticsReporting">analyticsReporting</a></code> | <code>boolean</code> | Include runtime versioning information in this Stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.description">description</a></code> | <code>string</code> | A description of the stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.env">env</a></code> | <code>aws-cdk-lib.Environment</code> | The AWS environment (account/region) where this stack will be deployed. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.stackName">stackName</a></code> | <code>string</code> | Name to deploy the stack with. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.synthesizer">synthesizer</a></code> | <code>aws-cdk-lib.IStackSynthesizer</code> | Synthesis method to use while deploying this stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Stack tags that will be applied to all the taggable resources and the stack itself. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.terminationProtection">terminationProtection</a></code> | <code>boolean</code> | Whether to enable termination protection for this stack. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.serviceName">serviceName</a></code> | <code>string</code> | Service name  used for all cloudformation resource names and internal aws resource names. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.stage">stage</a></code> | <code>string</code> | Stage name  used for all cloudformation resource names and internal aws resource names. |
| <code><a href="#cdk-internal-gateway.ResourceQueryResolverProps.property.vpcEndpointId">vpcEndpointId</a></code> | <code>string</code> | VPC endpoint id of execute-api vpc endpoint. |

---

##### `analyticsReporting`<sup>Optional</sup> <a name="analyticsReporting" id="cdk-internal-gateway.ResourceQueryResolverProps.property.analyticsReporting"></a>
...
##### `description`<sup>Optional</sup> <a name="description" id="cdk-internal-gateway.ResourceQueryResolverProps.property.description"></a>
...
##### `env`<sup>Optional</sup> <a name="env" id="cdk-internal-gateway.ResourceQueryResolverProps.property.env"></a>
...
##### `stackName`<sup>Optional</sup> <a name="stackName" id="cdk-internal-gateway.ResourceQueryResolverProps.property.stackName"></a>
...
##### `synthesizer`<sup>Optional</sup> <a name="synthesizer" id="cdk-internal-gateway.ResourceQueryResolverProps.property.synthesizer"></a>
...
##### `tags`<sup>Optional</sup> <a name="tags" id="cdk-internal-gateway.ResourceQueryResolverProps.property.tags"></a>
...
##### `terminationProtection`<sup>Optional</sup> <a name="terminationProtection" id="cdk-internal-gateway.ResourceQueryResolverProps.property.terminationProtection"></a>
...
##### `serviceName`<sup>Required</sup> <a name="serviceName" id="cdk-internal-gateway.ResourceQueryResolverProps.property.serviceName"></a>
...
##### `stage`<sup>Required</sup> <a name="stage" id="cdk-internal-gateway.ResourceQueryResolverProps.property.stage"></a>
...
##### `vpcEndpointId`<sup>Required</sup> <a name="vpcEndpointId" id="cdk-internal-gateway.ResourceQueryResolverProps.property.vpcEndpointId"></a>
